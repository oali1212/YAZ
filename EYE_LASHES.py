...
class NailSelectionWindow(QWidget):
    def __init__(self):
        ...
        buttons = [
            ("Classic", "./img/Gelpolish.jpg"), ("Volume", "./img/hardgel.jpg"), ("Mega Volume", "./img/Treatment.jpg"), ("Hybrid", "./img/Acrylic.jpg"),
            ("3D", "./img/simple_nail_design.jpg"), ("Classic \n cat \n eye", "./img/nails.jpg"), ("Volume \n cat \n eye", "./img/half_jell.jpg"),("Mega    \nVolume \n cat \n eye", "./img/half_jell.jpg"),
        ]
