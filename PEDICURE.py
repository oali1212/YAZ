...
class NailSelectionWindow(QWidget):
    def __init__(self):
        ...
        buttons = [
            ("Feet pedicure", "./img/Gelpolish.jpg"), ("pedicure\n+ \ngel polish", "./img/hardgel.jpg"), ("Feet pedicure \n+ Big toes\n Hard gel & the\n rest gel polish", "./img/Treatment.jpg"), ("paraffin \n + pedicure", "./img/Acrylic.jpg"), 
            ("Callus \n + \n pedicure", "./img/Gelpolish.jpg")
